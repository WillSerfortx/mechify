...
export default function About() {
  return (
    <div className="bg-[#050505] min-h-screen text-white font-outfit overflow-x-hidden">
      ...
      <section className="pt-40 pb-20 pl-12 pr-4 md:pl-24 md:pr-8 lg:pl-64 lg:pr-12">
      ...
      <section className="py-24 bg-black relative border-t border-white/5">
        <div className="max-w-[1600px] mx-auto pl-12 pr-4 md:pl-24 md:pr-8 lg:pl-64 lg:pr-12">
      ...
      <section className="py-24 pl-12 pr-4 md:pl-24 md:pr-8 lg:pl-64 lg:pr-12 bg-gradient-to-b from-black to-[#050505]">
