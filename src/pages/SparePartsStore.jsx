...
export default function SparePartsStore() {
  ...
  return (
    <div className="bg-black min-h-screen text-white font-outfit pb-24">
      {/* Hero Header */}
      <div className="relative bg-gradient-to-b from-[#1a0000] via-black to-black pt-28 pb-12 px-6 md:px-12 lg:px-20">
        <button
          onClick={() => navigate(-1)}
          className="absolute top-8 left-6 md:left-12 w-12 h-12 bg-white/10 backdrop-blur-md rounded-xl flex items-center justify-center text-2xl hover:bg-white/20 transition-colors border border-white/20 z-20"
        >
          &lt;
        </button>
