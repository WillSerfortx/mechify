...
const SelectField = ({ label, options }) => {
  return (
    <div className="relative group w-full mb-5">
      <select 
        className="w-full appearance-none bg-white border border-gray-400 text-black py-4 px-6 pr-14 text-lg rounded-xl outline-none cursor-pointer focus:border-red-500 focus:ring-1 focus:ring-red-500"
        defaultValue=""
      >
...
export default function CarBooking() {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-x-hidden font-outfit flex flex-col pt-32 pb-20">
      ...
      <div className="relative z-10 w-full mx-auto px-6 flex-1 flex flex-col items-center justify-center pb-20">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-14 lg:gap-20">
          ...
          {/* Form Card — bigger */}
          <div className="w-full max-w-[600px] bg-white rounded-3xl p-12 shadow-2xl animate-fadeInLeft relative z-20">
            <h2 className="text-4xl font-bold text-black mb-7">Start your booking</h2>
            ...
            <h2 className="text-4xl font-bold text-black mt-10 mb-7">Return</h2>
            <SelectField label="Choose Location" options={locations} />
            <SelectField label="Select Date" options={dates} />
            <SelectField label="Time" options={times} />
            ...
            <div className="flex items-center gap-3 mt-4 mb-10 cursor-pointer group" onClick={() => setDriverAge(!driverAge)}>
              ...
              <span className="text-base font-semibold text-black">Driver's age 25+</span>
            </div>

            <button 
              onClick={() => navigate('/payment-select')}
              className="w-full bg-[#E50914] hover:bg-red-700 text-white font-bold text-3xl py-5 rounded-full transition-all duration-300 hover:scale-[1.02] active:scale-95 shadow-md"
            >
              Next
            </button>
          </div>
          ...
          <div className="flex items-center justify-center animate-fadeInRight z-10">
            <h2 className="text-white text-6xl md:text-7xl xl:text-8xl font-bold leading-tight drop-shadow-2xl text-left">
              Car hire at<br />
              <span className="font-black text-7xl md:text-8xl xl:text-[110px]">All Over</span><br />
              <span className="font-black text-7xl md:text-8xl xl:text-[110px]">Bangladesh</span>
            </h2>
          </div>
