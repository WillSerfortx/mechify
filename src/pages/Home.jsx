  ...
  return (
    <div className="bg-black min-h-screen text-white font-outfit overflow-x-hidden">
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 bg-black" id="services-section" data-animate>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 max-w-[1400px] mx-auto w-full">
          {[
            ...
            <Link
              ...
              to={s.link}
              id={`large-service-${i}`}
              className={`relative rounded-2xl overflow-hidden group aspect-[4/3] cursor-pointer block w-full ${visible['services-section'] ? 'animate-fadeInUp' : 'opacity-0'}`}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-[1400px] mx-auto w-full">
          {[
            ...
            <Link
              ...
              to={s.link}
              id={`small-service-${i}`}
              className={`relative rounded-2xl overflow-hidden group aspect-video cursor-pointer block w-full ${visible['services-section'] ? 'animate-fadeInUp' : 'opacity-0'}`}
