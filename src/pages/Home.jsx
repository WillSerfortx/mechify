        ...
        <div className="flex flex-wrap justify-center items-center gap-6 mb-8 w-full max-w-[1800px] mx-auto pt-2">
          {[
            { 
              ...
              img: serviceImages.emergency, link: '/roadside', desc: 'Instant emergency support with live location tracking and towing if required.',
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 w-full max-w-[1800px] mx-auto">
          {[
            { 
              ...
              img: serviceImages.homeService, link: '/home-service', desc: 'On-demand mechanic services delivered directly to the customer’s home.' 
            },
            { 
              name: 'Marketplace',
